              ...
              <div>
                <div className="text-base-2 text-theme-primary mb-3">
                  ...
                  {formData.selectedToken && (
                    <span className="text-caption-1 text-theme-secondary ml-2">
                      ({formData.selectedToken})
                    </span>
                  )}
                </div>
                {!formData.selectedToken ? (
                  <div className="p-4 rounded-xl bg-theme-on-surface-2 border-2 border-theme-stroke text-theme-tertiary text-caption-1">
                    Please select a token first to set leverage
                  </div>
                ) : (
                  <div>
                    <div className="flex items-center gap-6 mb-3">
                      <div className="flex-1">
                        <Slider
                          min={2}
                          max={formData.selectedToken === "BTC" ? 40 : 25}
                          step={1}
                      ...
                      <div className="text-title-2 text-theme-primary font-semibold w-20 text-center">
                        {formData.leverage.toFixed(0)}X
                      </div>
                    </div>
                    <div className="p-3 rounded-lg bg-theme-on-surface-2/50 border border-theme-stroke">
                ...
                <div className="text-caption-2 text-theme-tertiary mt-2">
                  {!formData.selectedToken
                    ? "Select a token to adjust leverage"
                    : formData.selectedToken === "BTC"
                    ? "Adjust leverage between 2X and 40X"
                    : "Adjust leverage between 2X and 25X"}
                </div>
              </div>
